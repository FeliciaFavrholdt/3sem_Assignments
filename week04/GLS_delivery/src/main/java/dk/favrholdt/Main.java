...
public class Main {
    public static void main(String[] args) {
        ...
        PackageDAO packageDAO = insertDataToDB();
    ...
    private static PackageDAO insertDataToDB() {

        PackageDAO packageDAO = new PackageDAO(HibernateConfig.getEntityManagerFactoryConfig());
