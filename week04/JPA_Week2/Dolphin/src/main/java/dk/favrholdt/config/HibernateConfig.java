...
//            props.put("hibernate.hbm2ddl.auto", "update"); // "update" for updating hibernate creates tables based on entities
            props.put("hibernate.hbm2ddl.auto", "create"); // Set to "create" for overwriting
//            props.put("hibernate.hbm2ddl.auto", "create-drop"); // Set to "create-drop" for overwriting and dropping tables
